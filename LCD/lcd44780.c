...
void lcd_init(void)
{
	...
	//definiowanie polskich znakÛw

		uint8_t tab1[] = { 0, 0, 14, 1, 15, 17, 15, 2 };	//π
		uint8_t tab2[] = { 2, 4, 14, 16, 16, 17, 14, 0 };	//Ê
		uint8_t tab3[] = { 2, 4, 14, 16, 14, 1, 62, 0 };	//ú
		uint8_t tab4[] = { 4, 0, 31, 2, 4, 8, 31, 0 };		//ø
		uint8_t tab5[] = { 0, 0, 14, 17, 31, 16, 14, 4 };	//Í
		uint8_t tab6[] = { 2, 4, 22, 25, 17, 17, 17, 0 };	//Ò
